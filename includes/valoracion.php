...
<div id="modalValoracion" class="modal-valoracion-overlay" role="dialog" aria-modal="true"
    aria-labelledby="modalValoracionTitle" style="display: none;">
    <div class="modal-valoracion-content">
        <div class="modal-valoracion-header">
            <h2 id="modalValoracionTitle">Valorar Producto</h2>
            <button class="modal-close-btn" onclick="cerrarModalValoracion()"
                aria-label="Cerrar modal de valoración">&times;</button>
        </div>
