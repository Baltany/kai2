    ...
    <div class="kairos-header-container">
        ...
        <div class="kairos-bar">
            ...
            <div class="kairos-search" role="search">
                ...
                <input type="text" id="kairos-search-input" placeholder="Busca tus juegos favoritos..." aria-label="Buscar juegos">
            </div>
        ...
        <div class="kairos-actions-bar">
            <button class="kairos-action-btn" type="button" onclick="window.location.href='login.php'" aria-label="Iniciar sesión">
